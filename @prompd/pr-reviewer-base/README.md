...
const review = await executePrompt('@prompd/pr-reviewer-base/prompts/base-pr-reviewer.prmd', {
...
version: 1.0.0
inherits: "@prompd/pr-reviewer-base@0.0.1/prompts/base-pr-reviewer.prmd"
parameters:
  - name: pr_number
    type: integer
    required: true
...
jobs:
  review:
    ...
    steps:
      ...
      - name: Run AI Review
        run: |
          prompd exec @prompd/pr-reviewer-base/prompts/base-pr-reviewer.prmd \
...
- `@prompd/github-pr-reviewer` — GitHub-specific PR review implementation
- `@prompd/gitlab-pr-reviewer` — GitLab MR review implementation
