# Test Results: code-patterns.prmd

**Source File:** `../prompd-base\composable-packages\code-patterns\code-patterns.prmd`

**Test Date:** 2025-09-12 18:41:33
...
**Command Used:**
```bash
prompd run C:\git\github\Logikbug\prompd-base\composable-packages\code-patterns\code-patterns.prmd --provider anthropic --model claude-3-haiku-20240307 -p code_input=test-value
```
